...
bad.pdf: frames/options.json generate.py js/out/bad.js uv.lock
	uv run generate.py

frames/out/frames.bin: frames/out/build.txt frames/process_frames.py uv.lock
	cd frames; uv run process_frames.py

frames/out/build.txt: frames/src/badapple.mp4 frames/options.json frames/create-frames.sh
...
js/out/index.html: frames/out/frames.bin frames/options.json js/html/index.html js/shared/index.ts js/html/api.ts js/pnpm-lock.yaml js/vite.config.ts
	cd js; corepack pnpm vite build -m html

js/out/bad.js: frames/out/frames.bin frames/options.json js/shared/index.ts js/pdf/api.ts js/pnpm-lock.yaml js/vite.config.ts
